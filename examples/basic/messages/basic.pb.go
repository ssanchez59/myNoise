...
func (*BasicMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_7e3a394840361800, []int{0}
}
...
func init() {
	proto.RegisterFile("examples/basic/messages/basic.proto", fileDescriptor_basic_7e3a394840361800)
}

var fileDescriptor_basic_7e3a394840361800 = []byte{
